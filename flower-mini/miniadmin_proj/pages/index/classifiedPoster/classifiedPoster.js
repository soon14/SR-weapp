...
Page({
    ...
    refresh: function(_id) {
        ...
        let params = { cateid: _id, shopid: _shopid, width: res.windowWidth, height: y1 };
        utils.ajaxRequest(
            'shopMobile/category/GetCateQrcode',
            params,
            function(res) {
