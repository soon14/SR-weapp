...
App({
    ...
    lmxtAppId: 'wx300052d4386d2758', //乐墨学堂小程序appid
    ...
    auth: function () {
        ...
        // wx.request({
        //     url: 'https://ilearnmore.net/shopMobile/shopadmin/isBindGD',
        //     data: { params: _params, sign: _sign, timestamp: _timestamp, shopid: that.shopid },
            ...
            wx.login({
                success: function (res) {
                    if (res.code) {
                        ...
                        var _sign_code = md5.hex_md5(_timestamp + _params_code + that.shopkey);
                        wx.request({
                            ...
                            success: function (res) {
                                ...
                                wx.getUserInfo({
                                    ...
                                    fail: function () {
                                        ...
                                        wx.showModal({
                                            title: '温馨提示',
                                            content: '乐墨花时光是花店用来管理店铺的后台，为保证安全，请授权完成后再继续使用',
                                            showCancel: false,
                                            confirmText: '授权',
                                            success: function (res) {
                                                if (res.confirm) {
