...
var config = {
    ...
    colors: ['#ff3c32', '#f7a35c', '#434348', '#90ed7d', '#f15c80', '#8085e9'],
...
function drawXAxis(categories, opts, config, context) {
    ...
    if (config._xAxisTextAngle_ === 0) {
        context.beginPath();
        context.setFontSize(config.fontSize);
        context.setFillStyle(opts.xAxis.fontColor || '#ff3c32');
        categories.forEach(function (item, index) {
...
function drawYAxis(series, opts, config, context) {
    ...
    context.beginPath();
    context.setStrokeStyle(opts.yAxis.gridColor || "#cccccc");//背景线条颜色
    context.setLineWidth(1);
    points.forEach(function (item, index) {
    ...
    context.beginPath();
    context.setFontSize(config.fontSize);
    context.setFillStyle(opts.yAxis.fontColor || '#666666');//y轴文字颜色
